  ...
  return (
    <section className="flex justify-center mt-[30px] mb-[20px]">
      <main className=" text-center">
        ...
        {/* Tabs */}
        <div className="flex flex-cols ml-[130px] mr-[20px] justify-center relative">
        ...
        <div>
            ...
            <form className="grid grid-row-2 gap-y-[15px] px-[20px] mt-[1rem]  ml-[4rem] text-center">
                <input type="email" name="email" placeholder="Enter your email" className="h-[45px] ml-[44px] w-[400px] pl-[20px] rounded-[10px] border  bg-slate-100 outline-none hover:border-[#00BCD4] hover:bg-transparent justify-self-center" />
            ...
            {activeForm === "form2" && (
            <form className="grid grid-row-2 gap-y-[15px] px-[20px] mt-[1rem]  ml-[4rem] text-center">
                <input type="phone" name="phone" placeholder="Enter your phone number" className="h-[45px] ml-[44px] w-[400px] pl-[20px] rounded-[10px] border  bg-slate-100 outline-none hover:border-[#00BCD4] hover:bg-transparent justify-self-center" />
                <Link to="/signup/verify"><button className="py-[10px] bg-[#00BCD4] w-[400px] justify-self-center ml-[44px] text-white rounded-lg" >Continue</button></Link>
                <div className="w-[400px] bg-slate-100 ml-[44px] h-[2px] justify-self-center mt-[-5px]"></div>
                <div className="justify-self-center">
