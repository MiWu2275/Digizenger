...
function Collection(){
    const [showCustomize, setShowCustomize] = useState(false); // State to toggle view

    const handleCreateClick = () => {
        setShowCustomize(true); // Show CustomizeCollection when clicked
    };
    return(
        <>
         {showCustomize ? (
        ...
        <div className="w-[405px] h-[564.13px] bg-[#ECF1F4] rounded-lg flex flex-col items-center justify-center mt-60">
            ...
            <div className=" w-[365px] h-[505px] flex flex-col items-center justify-center">
                ...
                <div  onClick={handleCreateClick} className="hover:bg-[#C9DCDE] rounded-md w-[193px] h-[40px] flex items-center justify-center mt-4 ">
